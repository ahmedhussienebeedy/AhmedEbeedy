  ...
  const projects = [
    {
      ...
      description:
        "Personal portfolio built with React, Tailwind CSS, responsive design and modern UI.",
   ...
   <>
    <section className="relative min-h-screen w-full bg-[#0b0f19] overflow-hidden">
      ...
      <Fade direction="up" triggerOnce>
        <h2 className="text-center text-4xl md:text-5xl font-extrabold text-white pt-32">
          My Projects
        </h2>
      </Fade>
